	...
	<div id="wrapper">
		...
		<div id="resultados">
			<table class="ordenacion">
				<td>
					<a href="resultadosPrecio.jsp?lugar=<%=request.getParameter("lugar")%>">Ordenar por precio</a>
				</td>
			</table>
			<br/>
			...
			<div id="tablaResultados">
				<table class="tablaResultados">
					...
					<col width="150">
					<%
					ArrayList<ResultadoBusqueda> resultados = (ArrayList<ResultadoBusqueda>) session.getAttribute("resultados");				
					if(resultados!=null){
